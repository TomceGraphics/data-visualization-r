...
pch= c(1, 2, 16),  col         = c("#E74C3C","#3498DB","#27AE60"), 
main        = "Iris — All Pairwise Scatterplots", 
varname.cex = 0.7, # smaller font for variable names on diagonal
par.settings = list(    axis.text = list(cex = 0.5))) # smaller font for axis tick labels

#save as png
png("iris.png", width = 800, height = 600)
splom(~iris[, 1:4], 
groups= iris$Species, 
auto.key = list(    space= "right",    columns = 1  ),
pch= c(1, 2, 16),  col         = c("#E74C3C","#3498DB","#27AE60"), 
